        ...
        if APIFLASH_KEY == "ضع_مفتاحك_هنا":
            ...
            with st.spinner("جاري التقاط الصورة من السيرفر... ⏳"):
                try:
                    ...
                    api_url = api_url = f"https://api.apiflash.com/v1/urltoimage?access_key={85706f41977042d3b642677a65d0d81c}&url={encoded_url}&format=png&delay=3&width=550&scale_factor=2"
